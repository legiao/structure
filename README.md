# <a href="https://structure.js.org/"><img src="https://raw.githubusercontent.com/tiagogoncalves89/structure/master/structure.jpg" width="300"></a>

## A simple schema/attributes library built on top of modern JavaScript

[![npm](https://img.shields.io/npm/v/structure.svg?style=flat)](https://www.npmjs.com/package/structure-improved) [![Build Status](https://travis-ci.org/tiagogoncalves89/structure.svg?branch=master)](https://travis-ci.org/tiagogoncalves89/structure) [![Coverage Status](https://coveralls.io/repos/github/tiagogoncalves89/structure/badge.svg?branch=master)](https://coveralls.io/github/tiagogoncalves89/structure?branch=master) [![Code Climate](https://codeclimate.com/github/tiagogoncalves89/structure/badges/gpa.svg)](https://codeclimate.com/github/tiagogoncalves89/structure)
---
...
Not all major browsers implemented the used features so you'll need to transpile the code for using it. For browser usage we have the [UMD version](https://github.com/tiagogoncalves89/structure/blob/master/dist/structure.js) bundled with Webpack. We don't bundle Structure with its dependencies so you'll have to provide it with your module bundler. It's recommended to replace joi with [joi-browser](https://www.npmjs.com/package/joi-browser) when using it on the front-end, here's how we run our test suite on the browser regarding [bundling](https://github.com/tiagogoncalves89/structure/blob/master/test/karma.conf.js#L3-L11) and [polyfill of features](https://github.com/tiagogoncalves89/structure/blob/master/test/browserSetup.js#L1-L2).
